...
Her Claude oturumunun sonunda otomatik veya manuel çağrılır.
...
4. Session recap dosyasını oluştur:
   ```bash
   # .claude/memory/session-recap.md dosyasına yaz
   ```
...
Bu skill `.claude/hooks/auto-recap.sh` hook'u tarafından oturum sonunda
