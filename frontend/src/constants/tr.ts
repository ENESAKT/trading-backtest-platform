...
export const TR = {
  ...
  WIN_RATE: 'Paper Simülasyon Oranı',
  ...
  SIGNAL_BUY: 'AL Sinyali',
  SIGNAL_SELL: 'SAT Sinyali',
  SIGNAL_STRONG_BUY: 'Güçlü AL Sinyali',
  SIGNAL_STRONG_SELL: 'Güçlü SAT Sinyali',
  SIGNAL_HOLD: 'TUT',
  ...
  STRATEGY_DESC_DONCHIAN: 'Donchian kanalı üst bandı kırılımında AL yönlü, alt bandı kırılımında SAT yönlü teknik sinyal',
  STRATEGY_MACD: 'MACD Kesişimi',
  STRATEGY_DESC_MACD: 'MACD çizgisi sinyal çizgisini yukarı kesince AL yönlü, aşağı kesince SAT yönlü teknik sinyal',
  ...
  STRATEGY_DESC_LGBM: 'Eğitilmiş model varsa yükseliş olasılığıyla teknik sinyal filtresi',
  ...
  SIGNAL_FEED_INFO: 'Teknik sinyal akışı · Her bar kapanışında güncellenir · Yatırım tavsiyesi değildir',
  SIGNAL_FEED_EMPTY: 'Henüz sinyal yok',
  SIGNAL_DISCLAIMER: 'Bu içerik yatırım tavsiyesi değildir. Yalnızca teknik analiz göstergesidir. Finansal kararlarınızı kendi araştırmanız ve gerekirse lisanslı danışmanla değerlendirin.',
  DATA_LICENSE_DISCLAIMER: 'Veriler gecikmeli, eksik veya hatalı olabilir. Lisans ve kaynak durumu ilgili piyasada ayrıca belirtilir.',
  MARKET_DATA_NOTICE: 'Kripto: Binance public feed. BIST: lisanslı kaynak bekleniyor. VİOP: henüz aktif değil.',
  BIST_DATA_STATUS: 'BIST verileri için lisanslı veri sağlayıcı bağlantısı bekleniyor. Bu piyasa lisans süreci tamamlanana kadar fiyat/grafik/sinyal ekranında kapalıdır.',
  VIOP_DATA_STATUS: 'VİOP verileri için lisanslı kaynak bağlanmamıştır. Bu piyasa henüz aktif değildir.',
  CRYPTO_DATA_STATUS: 'Kripto verileri Binance public feed üzerinden gelir; ticari dağıtım koşulları sağlayıcı şartlarına tabidir.',
  PAPER_ONLY_WARNING: 'SANAL İŞLEM - Gerçek para, gerçek piyasa emri veya gerçek finansal sonuç söz konusu değildir.',
  BACKTEST_SIMULATION_WARNING: 'Bu backtest geçmiş veriye dayalı simülasyondur. Gelecekteki gerçek yatırım getirilerini göstermez.',
