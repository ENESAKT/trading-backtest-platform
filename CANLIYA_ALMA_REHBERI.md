...
> Uygulamanın bir alan adı (örn. `piyasapilotu.com`) olmalı ve HTTPS çalışmalı.
...
sudo certbot certonly --standalone -d piyasapilotu.com -d www.piyasapilotu.com
```
...
FRONTEND_URL=        # https://piyasapilotu.com
PUBLIC_BASE_URL=     # https://piyasapilotu.com
ALLOWED_ORIGINS=     # https://piyasapilotu.com,https://www.piyasapilotu.com
...
```
> Authorized redirect URI olarak şunu ekle: `https://piyasapilotu.com/api/auth/google/callback`
...
`https://piyasapilotu.com` adresine git. PiyasaPilot açılıyorsa 🎉
...
- **URL:** `https://piyasapilotu.com/api/payments/webhook`  ← **DİKKAT:** `/api/billing/webhook` değil, `/api/payments/webhook`
...
Telefonundan `https://piyasapilotu.com` aç:
...
| SSL sertifikası | `/etc/letsencrypt/live/piyasapilotu.com/` |
...
- [ ] Google OAuth Authorized redirect URI: `https://piyasapilotu.com/api/auth/google/callback` eklendi.
- [ ] Webhook URL Stripe'ta `https://piyasapilotu.com/api/payments/webhook` olarak kayıtlı.
