...
> Genel ilerleme: **%59 tamamlandı / %41 kaldı**
...
| [Bölüm 8 — i18n ve Hukuki Sayfalar](#bölüm-8--i18n-ve-hukuki-sayfalar) | [ ] | 86% | 14% | Public shell, landing/pricing ve auth görünür metinleri TR/EN sözlüğe bağlandı; terminal içi derin metinlerin i18n'e taşınması kaldı |
...
| **GENEL TOPLAM** | [ ] | **59%** | **41%** | Frontend kullanıcı yüzeyi, public/auth i18n, smoke QA, analytics/PWA ve E2E suite stabilize edildi; canlı dış entegrasyon ve platform işleri kaldı |
...
## Genel Değerlendirme: %59 Tamamlandı
...
| 8 — i18n / Hukuki | %86 | **%86** | Public shell, landing/pricing, auth ve risk dili TR/EN sözlüğe bağlandı; terminal içi tüm metinlerin taşınması kaldı |
