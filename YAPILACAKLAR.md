...
> Genel ilerleme: **%45 tamamlandı / %55 kaldı**
...
| [Bölüm 3 — Backend Auth Modülü](#bölüm-3--backend-auth-modülü) | [ ] | 70% | 30% | Register/login/me çalışıyor; endpoint guard, quota ve trial/free kararı netleşmeli |
...
| [Bölüm 9 — Mevcut UI Hataları](#bölüm-9--mevcut-ui-hataları) | [ ] | 85% | 15% | Siyah ekran/retry, kontrast, KAP, buton akışı büyük ölçüde yapıldı; regresyon testi kaldı |
...
| [Bölüm 16 — Eksik / Atlanan Teknik Maddeler](#bölüm-16--eksik--atlanan-teknik-maddeler) | [ ] | 55% | 45% | Birçok teknik madde uygulandı; kalanlar aşağıda işaretlenecek |
...
| **GENEL TOPLAM** | [ ] | **45%** | **55%** | Web MVP yaklaşık %70-75; tam production hedefi %45 |
...
- [ ] Yeni kayıt olan kullanıcının otomatik `pro` trial alması ürün kararı olarak netleştirilecek: isteniyorsa kalacak, değilse default `free` yapılacak.
...
### 16.1.1 · Google OAuth CSRF Koruması (state parametresi)
...
### 16.1.2 · Token Blacklist (Anlık Revoke)
...
### 16.1.3 · Şifre Gücü Doğrulama (Server-Side)
...
### 16.1.5 · Rate Limiting — Login Endpoint Brute Force
